...
class AlertViewModel(alert: Alert?) : ViewModel() {
    ...
    init {
        ...
        viewModelScope.launch {
            ...
            _symbol.postValue(cryptoTitles)
    ...
    suspend fun lookupPrice(symbol: Title, reference: Title, callback: (Pair<Double, Double>) -> Unit) {
        val it = TitleRepository.lookupPrice(symbol, reference)
