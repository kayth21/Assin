...
object Coinpaprika {
    ...
    private fun transform(row: JSONObject): Optional<Title> {
        ...
        return Optional.of(Title(id, symbol, Category.CRYPTO, name, priceUsd.toDouble(), priceBtc.toDouble(), marketCapUsd.toLong(), rank.toInt(), percentChange1h.toOptionalDouble(), percentChange24h.toOptionalDouble(), percentChange7d.toOptionalDouble(), transformTimestamp(lastUpdated.toLong()), Integer(1818)))
    }
